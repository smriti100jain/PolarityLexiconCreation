...
class Embedding(K.layers.Layer):
  ...
  def __init__(self,
               ...
               normalize=False,
               vocab_freqs=None,
               keep_prob=1.,word2vec_initialize=False,word2vecembeddingpath=None,
               **kwargs):
    self.vocab_size = vocab_size
    self.embedding_dim = embedding_dim
    self.normalized = normalize
    self.keep_prob = keep_prob
    self.word2vec_initialize = word2vec_initialize
    self.word2vecembeddingpath = word2vecembeddingpath
    if normalize:
  ...
  def build(self, input_shape):
    with tf.device('/cpu:0'):
      ...
      if self.word2vec_initialize:
        data = np.load(open(os.path.join(self.word2vecembeddingpath,'embedding.npz'),'rb'))
        ...
        print('----------------------------------------------------------------------------')
        #self.var = self.set_weight(word2vecembedding)
        '''
        ...
        self.var = tf.Variable(word2vecembedding,name="embedding")      
        print(self.var)
        self._trainable_weights.append(self.var)
        print('Over written......................................')
      else:
        self.var = self.add_weight(
            shape=(self.vocab_size, self.embedding_dim),
